...
local util = {
  ...
  try_get_signatures_from_markdown = function(func_name, docs)
    local all_sigs = {}
    ---@type string|nil
  ...
  ---@return string|nil content
  ---@async
  read_file_async = function(filename)
  ...
  mk_entry_points = function(package_name, exe_name, package_dir, mains, source_dirs)
    ---@type HsEntryPoint[]
    local entry_points = {}
